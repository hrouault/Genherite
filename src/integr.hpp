...
class Celleff
{
    public:
        ...
        vector< vector<double> > integrmultistable(int prot0, int prot1, int prot2);
        vector<double> integrporte(int nprotA, int nprotX, int nprotY, bool protX1, bool protY1, bool protX2, bool protY2);
...
class Reacteff
{
    public:
        ...
        Reacteff(double c, unsigned int re1, unsigned int re2, unsigned int pr1, unsigned int pr2);
};
...
class Recepteff
{
    public:
        ...
        Recepteff(unsigned int ps, unsigned int pc, unsigned int pp , double k, double e);
};
...
void prtrescells(Resultatsys res, ostream & fc1a, ostream & fc1b, ostream & fc1c,
                 ostream & fc2a, ostream & fc2b, ostream & fc2c,
                 ostream & fc3a, ostream & fc3b, ostream & fc3c);
